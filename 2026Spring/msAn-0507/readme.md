...
`KHNam`: Was the Q51→N51 substitution determined statistically from the training data, or through direct calculation of physicochemical interactions between the ligand and protein?
