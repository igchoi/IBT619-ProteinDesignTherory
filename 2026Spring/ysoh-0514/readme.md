...
- **Q1. contextualization 결봐를 보면 훨씬 더 좋은 성능을 보이는데, substrate를 하나에서 다른 하나로 옮기는 big enzyme machine과 같은 것인가요? (14m 10s)**
...
- **Q2. data set이 bacteria에 편향되어 있는 거 같은데, eukaryotic genome로 transfer가 가능한가요? (20m 58s)**
...
- **Q4. data에 포함된 noise를 어떻게 filtering 하나요? (24m 52s, 잘 안들려서 답변으로 유추했습니다.)**
  - A4. filtering 하지 않고, model이 스스로 일반화할 것입니다.
