...
`DHKim`: Both BoltzDesign and Protein Hunter try to get around the slow AF3 diffusion step. But since they run the model over and over, it feels like they are just relocation the computing time around instead of actually cutting it down. Do you have any ideas on how we can truly reduce the total computing time in the future? 
